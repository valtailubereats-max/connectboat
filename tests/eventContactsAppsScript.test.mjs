...
const sheet = new Sheet([['Name','Company','WhatsApp','Phone','Email','Website','LinkedIn','Other Contact','Invitation Channel','Invitation Status','Notes','Contact ID'],['Old','Boat','','','blocked@boat.com','','','','','Pending','Keep me','existing']]);
...
context.upsertContact(sheet,{contactId:'new',email:'new@boat.com',phone:'+447700123456'},cache);
context.upsertContact(sheet,{contactId:'new',email:'new@boat.com',phone:'+447700123456'},cache);
