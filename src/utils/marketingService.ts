...
const DEFAULT_MATERIALS: MarketingMaterial[] = [
  {
    ...
    content: `Hello! ⛵ You're invited to test ConnectBoat! 🇬🇧\n\nWe are the UK's dedicated boat and marine marketplace for boat sales, boat hire, engines, equipment, and nautical services. Connect directly on WhatsApp! 🚀\n\nList your boat for sale or hire for free today!\nVisit now: ${window.location.origin}\n\nYour feedback is greatly appreciated! 🤝`,
    mediaUrl: '',
  ...
  },
  {
    ...
    content: `Discover ConnectBoat! ⛵ The UK's premier marketplace for buying, selling, and hiring boats, yachts, jet skis, marine parts, and charter services. Deal directly on WhatsApp! 🚀\n\nVisit now: ${window.location.origin}`,
    mediaUrl: '',
    createdAt: '2026-06-13T10:11:52Z',
    createdBy: 'Admin',
    visualType: 'gradient',
