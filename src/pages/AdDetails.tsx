    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      {ad && (
        <Helmet>
          ...
          <meta property="og:image" content={images[0] || ad.imageUrl || 'https://connectboat.co.uk/og-image.png'} />
          ...
          <meta name="twitter:image" content={images[0] || ad.imageUrl || 'https://connectboat.co.uk/og-image.png'} />
