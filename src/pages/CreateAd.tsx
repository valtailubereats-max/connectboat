  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const adData: any = {
        ...
        beam: String(formData.beam ?? '').trim(),
        draft: String(formData.draft ?? '').trim(),
        fuelType: formData.fuelType || '',
        engineBrand: String(formData.engineBrand ?? '').trim(),
        horsepower: String(formData.horsepower ?? '').trim(),
        engineHours: String(formData.engineHours ?? '').trim(),
        cabins: String(formData.cabins ?? '').trim(),
        berths: String(formData.berths ?? '').trim(),
        bathrooms: String(formData.bathrooms ?? '').trim(),
