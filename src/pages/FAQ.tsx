...
const FAQ = () => {
  ...
  const faqData: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'Reach out to us via direct support or email support@connectboat.com. Our team is available to assist you with any questions.'
    }
  ];
      ...
      >
        ...
        <div className="bg-[#bfead0]/30 rounded-[2.5rem] p-8 border border-[#a8dec0]/40 text-center max-w-xl mx-auto mt-12">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a
              href="mailto:support@connectboat.com"
